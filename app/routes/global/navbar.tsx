  ...
  return (
    <div className="navbar bg-base-100">
        <div className="flex-1">
            <a className="normal-case text-xl">Lua website</a>
        </div>
        <div className="flex-none">
            <ul className="menu menu-horizontal p-0">
                <li><NavLink to="/features" className="selected">Features</NavLink></li>
                <li><NavLink to="/media" className="selected">Media</NavLink></li>
                <li><NavLink to="/purchase" className="selected">Purchase</NavLink></li>
                <li><NavLink to="/faq" className="selected">FAQ</NavLink></li>
